...
class TreatmentItem(Base):
    ...
    treatment_id = Column(Integer, ForeignKey("treatment.id", ondelete="CASCADE"), nullable=False, comment="시술 예약 ID")
    menu_detail_id = Column(Integer, ForeignKey("treatment_menu_detail.id", ondelete="SET NULL"), nullable=True, comment="시술 상세 ID")
