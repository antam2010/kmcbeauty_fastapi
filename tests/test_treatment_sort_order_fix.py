...
def test_invalid_sort_order_does_not_crash_and_defaults_desc():
...
def test_valid_sort_order_asc_is_applied():
...
def test_valid_sort_order_desc_is_applied():
...
def test_unknown_sort_by_skips_order_by():
