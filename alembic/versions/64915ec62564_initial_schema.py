...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True, comment='생성일'),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'), nullable=True, comment='수정일'),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True, comment='생성일시'),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True, comment='수정일시'),
    sa.Column('deleted_at', sa.DateTime(), nullable=True, comment='삭제일시 (soft delete)'),
    sa.ForeignKeyConstraint(['shop_id'], ['shop.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('total_price', sa.Integer(), nullable=False, comment='총 실제 시술 가격'),
