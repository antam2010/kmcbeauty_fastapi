...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'MASTER', 'MANAGER', name='userrole'), server_default='MASTER', nullable=False, comment='유저 권한'),
    ...
    sa.Column('address_detail', sa.String(length=255), nullable=True, comment='샵 상세 주소'),
    sa.Column('phone', sa.String(length=20), nullable=True, comment='샵 전화번호'),
    sa.Column('business_number', sa.String(length=20), nullable=True, comment='사업자 등록 번호'),
    sa.Column('deleted_at', sa.DateTime(), nullable=True, comment='삭제일시'),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='생성일시'),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='수정일시'),
    ...
    sa.Column('group_name', sa.String(length=100), nullable=True, comment='그룹명 (선택)'),
    ...
    op.create_index('idx_shop_deleted_group', 'phonebook', ['shop_id', 'deleted_at', 'group_name'], unique=False)
    op.create_index('idx_shop_deleted_name', 'phonebook', ['shop_id', 'deleted_at', 'name'], unique=False)
    op.create_index('idx_shop_deleted_phone', 'phonebook', ['shop_id', 'deleted_at', 'phone_number'], unique=False)
    op.create_table('shop_invite',
    sa.Column('id', sa.Integer(), nullable=False, comment='초대코드 ID'),
    sa.Column('shop_id', sa.Integer(), nullable=False, comment='샵 ID'),
    sa.Column('invite_code', sa.String(length=20), nullable=False, comment='초대코드'),
    ...
    sa.Column('is_primary_owner', sa.Integer(), nullable=False, comment='대표 원장 여부 (1=대표, 0=아님)'),
    sa.ForeignKeyConstraint(['shop_id'], ['shop.id'], ondelete='CASCADE'),
    ...
    op.create_table('treatment_menu',
    sa.Column('id', sa.Integer(), nullable=False, comment='시술 메뉴 대분류 ID'),
    sa.Column('shop_id', sa.Integer(), nullable=False, comment='샵 ID'),
    sa.Column('name', sa.String(length=255), nullable=False, comment='시술 대분류명'),
    sa.Column('deleted_at', sa.DateTime(), nullable=True, comment='삭제일시'),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='생성일시'),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='수정일시'),
    sa.ForeignKeyConstraint(['shop_id'], ['shop.id'], ondelete='CASCADE'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='생성일시'),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='수정일시'),
    sa.ForeignKeyConstraint(['phonebook_id'], ['phonebook.id'], ),
    sa.ForeignKeyConstraint(['shop_id'], ['shop.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    comment='시술 예약 테이블'
    )
    op.create_index(op.f('ix_treatment_id'), 'treatment', ['id'], unique=False)
    op.create_table('treatment_menu_detail',
    sa.Column('id', sa.Integer(), nullable=False, comment='시술 상세 ID'),
    sa.Column('menu_id', sa.Integer(), nullable=False, comment='시술 메뉴 대분류 ID'),
    sa.Column('name', sa.String(length=255), nullable=False, comment='시술 항목명'),
    sa.Column('duration_min', sa.Integer(), nullable=False, comment='기본 시술 시간 (분)'),
    sa.Column('base_price', sa.Integer(), nullable=False, comment='기본 시술 가격 (원)'),
    sa.Column('deleted_at', sa.DateTime(), nullable=True, comment='삭제일시'),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='생성일시'),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='수정일시'),
    ...
    op.create_index(op.f('ix_treatment_menu_detail_id'), 'treatment_menu_detail', ['id'], unique=False)
    ...
    sa.Column('menu_detail_id', sa.Integer(), nullable=True, comment='시술 상세 ID'),
    sa.Column('base_price', sa.Integer(), server_default='0', nullable=False, comment='기본 가격'),
    sa.Column('duration_min', sa.Integer(), server_default='0', nullable=False, comment='소요 시간 (분)'),
    sa.Column('session_no', sa.SmallInteger(), server_default='1', nullable=False, comment='시술 회차'),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='생성일시'),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='수정일시'),
    sa.ForeignKeyConstraint(['menu_detail_id'], ['treatment_menu_detail.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['treatment_id'], ['treatment.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    comment='시술 항목 테이블'
    )
    op.create_index(op.f('ix_treatment_item_id'), 'treatment_item', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_treatment_menu_detail_id'), table_name='treatment_menu_detail')
