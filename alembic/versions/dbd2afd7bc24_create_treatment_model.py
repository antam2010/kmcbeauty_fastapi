...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(length=255), nullable=False, comment='예약 시점의 시술명 (스냅샷)'),
    sa.Column('duration_min', sa.Integer(), nullable=False, comment='시술 시간 (수정 가능)'),
    sa.Column('price', sa.Integer(), nullable=False, comment='시술 가격 (수정 가능)'),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True, comment='생성일시'),
